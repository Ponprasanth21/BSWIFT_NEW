...
public class ManualTransactionPojo {
	...
	private ManualTransaction manual;
	...
	public ManualTransactionPojo() {
		super();
		// TODO Auto-generated constructor stub
	}
	public ManualTransactionPojo(String doc_sub_id, String doc_ref_id, Date tran_date, Date value_date,
			...
			Date entry_time, Date verify_time, Date modify_time, String entry_user, String modify_user,
			String verify_user, String entity_flg, String modify_flg, String del_flg, String master_ref_no,
			String ips_ref_no, String tran_particular) {
		super();
		this.doc_sub_id = doc_sub_id;
		this.doc_ref_id = doc_ref_id;
		this.tran_date = tran_date;
	...
	public ManualTransactionPojo(ManualTransaction manual) {
		this.doc_sub_id = manual.getDoc_sub_id();
		this.doc_ref_id = manual.getDoc_ref_id();
		this.tran_date = manual.getTran_date();
		this.value_date = manual.getValue_date();
		this.tran_ref_id = manual.getTran_ref_id();
		this.tran_type = manual.getTran_type();
		this.tran_ref_part_tran_id = manual.getTran_ref_part_tran_id();
		this.remit_account_no = manual.getRemit_account_no();
		this.rem_name = manual.getRem_name();
		this.rem_mobile_no = manual.getRem_mobile_no();
		this.rem_nic_no = manual.getRem_nic_no();
		this.ben_bank_code = manual.getBen_bank_code();
		this.ben_branch_code = manual.getBen_branch_code();
		this.ben_acct_no = manual.getBen_acct_no();
		this.ben_acct_name = manual.getBen_acct_name();
		this.ben_nick_name = manual.getBen_nick_name();
		this.tran_crncy_code = manual.getTran_crncy_code();
		this.tran_amt = manual.getTran_amt();
		this.chk_flg = manual.getChk_flg();
		this.chg_amt = manual.getChg_amt();
		this.def_chg_amt = manual.getDef_chg_amt();
		this.split_flg = manual.getSplit_flg();
		this.split_mast_tran_ref = manual.getSplit_mast_tran_ref();
		this.entry_time = manual.getEntry_time();
		this.verify_time = manual.getVerify_time();
		this.modify_time = manual.getModify_time();
		this.entry_user = manual.getEntry_user();
		this.modify_user = manual.getModify_user();
		this.verify_user = manual.getVerify_user();
		this.entity_flg = manual.getEntity_flg();
		this.modify_flg = manual.getModify_flg();
		this.del_flg = manual.getDel_flg();
		this.master_ref_no = manual.getMaster_ref_no();
		this.ips_ref_no = manual.getIps_ref_no();
		this.tran_particular = manual.getTran_particular();
	}

...
public class IPSUserPreofileMod implements UserDetails {
	...
	/*
	 * @Override public String toString() { return "UserProfileModEn [bank_code=" +
	 * bank_code + ", bank_name=" + bank_name + ", branch_code=" + branch_code +
	 * ", branch_name=" + branch_name + ", empid=" + empid + ", emp_name=" +
	 * emp_name + ", userid=" + userid + ", username=" + username +
	 * ", inactive_time=" + inactive_time + ", acc_exp_date=" + acc_exp_date +
	 * ", login_low=" + login_low + ", login_high=" + login_high +
	 * ", disable_start_date=" + disable_start_date + ", disable_end_date=" +
	 * disable_end_date + ", password=" + password + ", pass_exp_date=" +
	 * pass_exp_date + ", user_status=" + user_status + ", login_status=" +
	 * login_status + ", virtual_flg=" + virtual_flg + ", work_class=" + work_class
	 * + ", mob_number=" + mob_number + ", email_id=" + email_id + ", role_id=" +
	 * role_id + ", role_desc=" + role_desc + ", permissions=" + permissions +
	 * ", per_effctive_date=" + per_effctive_date + ", admin=" + admin +
	 * ", xbrl_configuration=" + xbrl_configuration + ", xbrl_report=" + xbrl_report
	 * + ", scheduler=" + scheduler + ", execution=" + execution + ", mis_reports="
	 * + mis_reports + ", xml_reports=" + xml_reports + ", archivel=" + archivel +
	 * ", general_inq=" + general_inq + ", audit_inq=" + audit_inq + ", channel=" +
	 * channel + ", entry_user=" + entry_user + ", entry_time=" + entry_time +
	 * ", auth_user=" + auth_user + ", auth_time=" + auth_time + ", modify_user=" +
	 * modify_user + ", modify_time=" + modify_time + ", entity_flg=" + entity_flg +
	 * ", auth_flg=" + auth_flg + ", modify_flg=" + modify_flg + ", del_flg=" +
	 * del_flg + ", session_id=" + session_id + ", login_flg=" + login_flg +
	 * ", user_locked_flg=" + user_locked_flg + ", no_of_attmp=" + no_of_attmp +
	 * ", disable_flg=" + disable_flg + ", new_user_flg=" + new_user_flg +
	 * ", domain_id=" + domain_id + ", remarks=" + remarks + "]"; }
	 */
	...
	public String toString() {
		return "IPSUserPreofileMod [bank_code=" + bank_code + ", bank_name=" + bank_name + ", branch_code="
				...
				+ ", password=" + password + ", pass_exp_date=" + pass_exp_date + ", user_status=" + user_status
				+ ", login_status=" + login_status + ", virtual_flg=" + virtual_flg + ", work_class=" + work_class
				+ ", mob_number=" + mob_number + ", email_id=" + email_id + ", role_id=" + role_id + ", role_desc="
				+ role_desc + ", permissions=" + permissions + ", per_effctive_date=" + per_effctive_date + ", admin="
				+ admin + ", xbrl_configuration=" + xbrl_configuration + ", xbrl_report=" + xbrl_report + ", scheduler="
				...
				+ new_user_flg + ", remarks=" + remarks + ", country_code=" + country_code + "]";
	}
	...
	public  IPSUserPreofileMod(UserProfile userProfile) {
		...
		this.country_code = userProfile.getCountry_code();
	}
	
	
	
	/*
	 * public IPSUserPreofileMod(String bank_code, String bank_name, String
	 * branch_code, String branch_name, String empid, String emp_name, String
	 * userid, String username, String inactive_time, Date acc_exp_date, String
	 * login_low, String login_high, Date disable_start_date, Date disable_end_date,
	 * String password, Date pass_exp_date, String user_status, String login_status,
	 * String virtual_flg, String work_class, String mob_number, String email_id,
	 * String role_id, String role_desc, String permissions, String
	 * per_effctive_date, String admin, String xbrl_configuration, String
	 * xbrl_report, String scheduler, String execution, String mis_reports, String
	 * xml_reports, String archivel, String general_inq, String audit_inq, String
	 * channel, String entry_user, Date entry_time, String auth_user, Date
	 * auth_time, String modify_user, Date modify_time, String entity_flg, String
	 * auth_flg, String modify_flg, String del_flg, String session_id, String
	 * login_flg, String user_locked_flg, Integer no_of_attmp, String disable_flg,
	 * String new_user_flg, String domain_id,String remarks) { super();
	 * this.bank_code = bank_code; this.bank_name = bank_name; this.branch_code =
	 * branch_code; this.branch_name = branch_name; this.empid = empid;
	 * this.emp_name = emp_name; this.userid = userid; this.username = username;
	 * this.inactive_time = inactive_time; this.acc_exp_date = acc_exp_date;
	 * this.login_low = login_low; this.login_high = login_high;
	 * this.disable_start_date = disable_start_date; this.disable_end_date =
	 * disable_end_date; this.password = password; this.pass_exp_date =
	 * pass_exp_date; this.user_status = user_status; this.login_status =
	 * login_status; this.virtual_flg = virtual_flg; this.work_class = work_class;
	 * this.mob_number = mob_number; this.email_id = email_id; this.role_id =
	 * role_id; this.role_desc = role_desc; this.permissions = permissions;
	 * this.per_effctive_date = per_effctive_date; this.admin = admin;
	 * this.xbrl_configuration = xbrl_configuration; this.xbrl_report = xbrl_report;
	 * this.scheduler = scheduler; this.execution = execution; this.mis_reports =
	 * mis_reports; this.xml_reports = xml_reports; this.archivel = archivel;
	 * this.general_inq = general_inq; this.audit_inq = audit_inq; this.channel =
	 * channel; this.entry_user = entry_user; this.entry_time = entry_time;
	 * this.auth_user = auth_user; this.auth_time = auth_time; this.modify_user =
	 * modify_user; this.modify_time = modify_time; this.entity_flg = entity_flg;
	 * this.auth_flg = auth_flg; this.modify_flg = modify_flg; this.del_flg =
	 * del_flg; this.session_id = session_id; this.login_flg = login_flg;
	 * this.user_locked_flg = user_locked_flg; this.no_of_attmp = no_of_attmp;
	 * this.disable_flg = disable_flg; this.new_user_flg = new_user_flg;
	 * this.domain_id = domain_id; this.remarks=remarks; }
	 */
	...
	public IPSUserPreofileMod(String bank_code, String bank_name, String branch_code, String branch_name, String empid,
			...
			String login_flg, String user_locked_flg, Integer no_of_attmp, String disable_flg, byte[] photo,
			String domain_id, String new_user_flg, String remarks, String country_code) {
		super();
		this.bank_code = bank_code;
		this.bank_name = bank_name;
		this.branch_code = branch_code;

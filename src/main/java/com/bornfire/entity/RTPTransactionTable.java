...
@Entity
@Table(name="BIPS_RTP_TRAN_MASTER")
@IdClass(RTPTransactionTableID.class)
public class RTPTransactionTable implements Serializable{
	...
	public RTPTransactionTable(String doc_sub_id, String doc_ref_id, Date tran_date, Date value_date, String tran_ref_id,

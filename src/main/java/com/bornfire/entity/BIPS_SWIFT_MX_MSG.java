...
@Entity
@Table(name="BIPS_SWIFT_MX_MSG_TABLE")
@Component
public class BIPS_SWIFT_MX_MSG implements Serializable{
	...
	@Lob
	private String	mx_message_file;
	...
	public String getMx_message_file() {
		return mx_message_file;
	}

	public void setMx_message_file(String mx_message_file) {
		this.mx_message_file = mx_message_file;
	}
	...
	public BIPS_SWIFT_MX_MSG(String srl_no, String file_mgt_ref_no, String sender_reference, String msg_type,
			String mx_message_file, String remitant_name, String remitant_account, String beneficairy_name,
			...
			String remittance_address, String beneficiary_address, String bank_operation_code, String debitor_account,
			String creditor_account, String msg_id, Date date_of_process) {
		super();
		this.srl_no = srl_no;
		this.file_mgt_ref_no = file_mgt_ref_no;
		this.sender_reference = sender_reference;

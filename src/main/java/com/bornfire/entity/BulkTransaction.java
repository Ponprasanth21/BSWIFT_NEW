...
@Entity
@Table(name = "BIPS_BULK_TRAN_MASTER")
@IdClass(BulkTransactionDetailID.class)
public class BulkTransaction implements Serializable {
	...
	public BulkTransaction(Date tran_date, Date value_date, String tran_ref_id, String tran_type,
			BigDecimal tran_ref_part_tran_id, String remit_account_no, String rem_name, String rem_mobile_no,
			String rem_nic_no, String ben_bank_code, String ben_branch_code, String ben_acct_no, String ben_acct_name,
			String ben_nick_name, String tran_crncy_code, BigDecimal tran_amt, String chk_flg, BigDecimal chg_amt,
			BigDecimal def_chg_amt, String split_flg, String split_mast_tran_ref, Date entry_time, Date verify_time,
			Date modify_time, String entry_user, String modify_user, String verify_user, String entity_flg,
			String modify_flg, String del_flg, String master_ref_no, String doc_ref_id, String doc_sub_id) {
		super();
		this.tran_date = tran_date;
		this.value_date = value_date;
		this.tran_ref_id = tran_ref_id;
	...
	public String toString() {
		return "BulkTransaction [tran_date=" + tran_date + ", value_date=" + value_date + ", tran_ref_id=" + tran_ref_id
				+ ", tran_type=" + tran_type + ", tran_ref_part_tran_id=" + tran_ref_part_tran_id
				+ ", remit_account_no=" + remit_account_no + ", rem_name=" + rem_name + ", rem_mobile_no="
				+ rem_mobile_no + ", rem_nic_no=" + rem_nic_no + ", ben_bank_code=" + ben_bank_code
				+ ", ben_branch_code=" + ben_branch_code + ", ben_acct_no=" + ben_acct_no + ", ben_acct_name="
				+ ben_acct_name + ", ben_nick_name=" + ben_nick_name + ", tran_crncy_code=" + tran_crncy_code
				+ ", tran_amt=" + tran_amt + ", chk_flg=" + chk_flg + ", chg_amt=" + chg_amt + ", def_chg_amt="
				+ def_chg_amt + ", split_flg=" + split_flg + ", split_mast_tran_ref=" + split_mast_tran_ref
				+ ", entry_time=" + entry_time + ", verify_time=" + verify_time + ", modify_time=" + modify_time
				...
				+ ", master_ref_no=" + master_ref_no + ", doc_ref_id=" + doc_ref_id + ", doc_sub_id=" + doc_sub_id
				+ "]";
	}
